...
# dashboard's pre-write mutation validation (papylonation_cli/web_server.py) so
...
class GatewayConfig:
    ...
    # Storage paths
    sessions_dir: Path = field(default_factory=lambda: get_papylonation_home() / "sessions")
...
def load_gateway_config() -> GatewayConfig:
    ...
    try:
        ...
        if config_yaml_path.exists():
            ...
            # through papylonation_cli.config.load_config, so without this a managed
