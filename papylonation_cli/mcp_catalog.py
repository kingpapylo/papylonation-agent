...
from papylonation_constants import get_papylonation_home, get_optional_mcps_dir
...
from papylonation_cli.cli_output import prompt as _prompt_input
...
def _install_root() -> Path:
    ...
    root = get_papylonation_home() / "mcp-installs"
...
def _build_server_config(
    ...
    by papylonation_cli/mcp_config.py."""
    cfg: dict = {}
    t = entry.transport
    if t.type == "stdio":
