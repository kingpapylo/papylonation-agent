...
from papylonation_constants import display_papylonation_home, is_termux as _is_termux_environment
...
class CLICommandsMixin:
    ...
    def _handle_snapshot_command(self, command: str):
        ...
        """
        from papylonation_cli.backup import (
        ...
        if subcmd in {"list", "ls"}:
            ...
            if not snaps:
                ...
                return
            print(f"  State snapshots ({display_papylonation_home()}/state-snapshots/):\n")
    ...
    def _handle_journey_command(self, cmd_original: str) -> None:
        ...
        from cli import _cprint
        from papylonation_cli.journey import register_cli
    ...
    def _handle_paste_command(self):
        ...
        from papylonation_cli.clipboard import has_clipboard_image
    ...
    def _handle_tools_command(self, cmd: str):
        ...
        def _run_capture(ns: Namespace) -> None:
            ...
            # Buffer reports isatty()=True so color() in papylonation_cli/colors.py
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if target.isdigit():
            ...
            from papylonation_cli.main import _resolve_session_by_name_or_id
    ...
    def _handle_pet_command(self, cmd: str):
        ...
        from papylonation_cli.pets import _set_active, _set_enabled, print_pet_gallery, set_pet_scale, toggle_pet_display
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        Delegates to papylonation_cli.curator so the CLI and the `hermes curator`
        ...
        try:
            from papylonation_cli.curator import cli_main
            cli_main(tokens)
        except SystemExit:
    ...
    def _handle_skills_command(self, cmd: str):
        """Handle /skills slash command — delegates to papylonation_cli.skills_hub."""
        ...
        if args and args[0].lower() in {"pending", "approve", "apply", "reject",
            ...
            if out is not None:
                print(out)
                return
        from papylonation_cli.skills_hub import handle_skills_slash
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        try:
            from papylonation_cli.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
        ...
        if len(parts) < 2 or not parts[1].strip():
            ...
            print("\n  Usage: /skin <name>")
            print(f"  Custom skins: drop a YAML file in {display_papylonation_home()}/skins/\n")
            return
    ...
    def _compose_in_editor(self, initial_text: str = "") -> str:
        ...
        fd, path = tempfile.mkstemp(suffix=".md", prefix="papylonation_prompt_")
        try:
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from papylonation_cli.models import _is_anthropic_fast_model
