...
.. code-block:: python
    ...
    from papylonation_cli.skin_engine import get_active_skin, list_skins, set_active_skin
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            ...
            "welcome": "Welcome to PapyloNation Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
...
def _skins_dir() -> Path:
    ...
    return get_papylonation_home() / "skins"
