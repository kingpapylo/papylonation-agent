...
from papylonation_cli.cli_output import prompt_yes_no
from papylonation_cli.curses_ui import curses_single_select
from papylonation_cli.mcp_catalog import (
    CatalogEntry,
    CatalogError,
    catalog_diagnostics,
    install_entry,
...
def _configure_tools(name: str) -> None:
    ...
    """
    import argparse
    from papylonation_cli.mcp_config import cmd_mcp_configure
