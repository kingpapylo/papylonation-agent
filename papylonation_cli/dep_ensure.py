...
_DEP_CHECKS = {
    ...
    "browser": lambda: (
        ...
        or _has_papylonation_agent_browser()
    ),
...
def _has_papylonation_agent_browser() -> bool:
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-HermesHome", str(get_papylonation_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = papylonation_subprocess_env(inherit_credentials=False)
