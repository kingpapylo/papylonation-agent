...
def build_models_payload(
    ...
    *,
    ...
    try:
        from papylonation_cli.providers import is_routing_aggregator as _is_routing_aggregator
    except Exception:
...
def _append_unconfigured_rows(
    ...
    *,
    ...
    from papylonation_cli.models import CANONICAL_PROVIDERS, _PROVIDER_LABELS
...
def _moa_provider_row(current_provider: str = "") -> dict | None:
    ...
    picker path (:func:`papylonation_cli.model_switch.list_picker_providers`) so the
