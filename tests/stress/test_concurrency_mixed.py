...
def worker_loop(worker_id: int, papylonation_home: str, result_file: str) -> None:
...
def reclaimer_loop(papylonation_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="papylonation_mixed_stress_")
