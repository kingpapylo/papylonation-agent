...
def isolate(tmp_path, monkeypatch):
    monkeypatch.setattr("gateway.delivery.get_papylonation_home", lambda: tmp_path)
    monkeypatch.setattr("gateway.dead_targets.get_papylonation_home", lambda: tmp_path)
    return tmp_path
