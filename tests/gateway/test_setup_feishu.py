"""Tests for _setup_feishu() in papylonation_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("papylonation_cli.config.save_env_value", side_effect=mock_save), \
         patch("papylonation_cli.config.get_env_value", side_effect=mock_get), \
         patch("papylonation_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("papylonation_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("papylonation_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("papylonation_cli.cli_output.print_header"), \
         patch("papylonation_cli.cli_output.print_info"), \
         patch("papylonation_cli.cli_output.print_success"), \
         patch("papylonation_cli.cli_output.print_warning"), \
         patch("papylonation_cli.cli_output.print_error"), \
