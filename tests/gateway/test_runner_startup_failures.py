...
async def test_start_gateway_verbosity_imports_redacting_formatter(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("papylonation_logging.setup_logging", lambda papylonation_home, mode: tmp_path)
    monkeypatch.setattr("papylonation_logging._add_rotating_handler", lambda *args, **kwargs: None)
