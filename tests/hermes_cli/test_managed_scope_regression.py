...
def test_user_config_overrides_default(papylonation_home, monkeypatch):
    from papylonation_cli.config import load_config, cfg_get
...
def test_env_expansion_in_user_config(papylonation_home, monkeypatch):
    from papylonation_cli.config import load_config, cfg_get
...
def test_no_managed_dir_means_user_value_wins(papylonation_home):
...
def test_user_env_overrides_shell(tmp_path, monkeypatch):
    ...
    load_papylonation_dotenv(papylonation_home=str(home))
