...
def test_spawn_whatsapp_pairing_process_uses_json_mode(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(papylonation_constants, "find_node_executable", lambda command: "/usr/bin/node")
    monkeypatch.setattr(papylonation_constants, "with_papylonation_node_path", lambda env=None: {})
