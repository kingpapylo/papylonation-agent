...
def test_recommended_update_command_defaults_to_papylonation_update(monkeypatch):
    ...
    with patch("papylonation_cli.config.get_managed_update_command", return_value=None), \
