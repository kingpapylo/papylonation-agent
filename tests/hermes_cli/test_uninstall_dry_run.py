...
from papylonation_cli import uninstall
...
def test_dry_run_prints_plan_without_mutating(monkeypatch, tmp_path, capsys):
    ...
    monkeypatch.setattr(uninstall, "_is_default_papylonation_home", lambda home: False)
    ...
    assert str(papylonation_home) in output
