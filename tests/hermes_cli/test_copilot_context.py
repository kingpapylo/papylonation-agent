...
from papylonation_cli.models import get_copilot_model_context
...
def _clear_cache():
    ...
    import papylonation_cli.models as mod
...
class TestGetCopilotModelContext:
    ...
    @patch("papylonation_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("papylonation_cli.models.fetch_github_model_catalog", return_value=None)
    def test_returns_none_when_catalog_unavailable(self, mock_fetch):
        assert get_copilot_model_context("gpt-4.1") is None

    @patch("papylonation_cli.models.fetch_github_model_catalog", return_value=[])
