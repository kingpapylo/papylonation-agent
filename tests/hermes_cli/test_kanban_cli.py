"""Tests for the kanban CLI surface (papylonation_cli.kanban)."""
...
from papylonation_cli import kanban as kc
...
def test_kanban_in_autocomplete_table():
    from papylonation_cli.commands import COMMANDS, SUBCOMMANDS
...
def test_kanban_not_gateway_only():
    ...
    from papylonation_cli.commands import COMMAND_REGISTRY
