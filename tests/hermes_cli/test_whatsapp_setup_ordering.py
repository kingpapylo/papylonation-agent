...
def _env_value(papylonation_home: Path, key: str) -> str | None:
    env_file = papylonation_home / ".env"
...
def test_aborted_setup_does_not_enable_whatsapp(isolated_home, monkeypatch):
    ...
    """
    from papylonation_cli.main import cmd_whatsapp
    ...
    monkeypatch.setattr("papylonation_cli.main._require_tty", lambda *_a, **_kw: None)
