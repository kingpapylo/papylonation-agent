...
papylonation_cli.config._load_config_impl, so the managed-scope merge has to be
...
def _load_cli_config(home):
    ...
    cli.py binds ``_papylonation_home = get_papylonation_home()`` at import time (module
