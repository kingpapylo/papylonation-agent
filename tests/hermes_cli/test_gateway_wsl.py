...
# =============================================================================
# is_wsl() in papylonation_constants
# =============================================================================
...
class TestIsWsl:
    ...
    def test_detects_wsl2(self):
        ...
        with patch("builtins.open", mock_open(read_data=fake_content)):
            assert papylonation_constants.is_wsl() is True
    ...
    def test_native_linux(self):
        ...
        with patch("builtins.open", mock_open(read_data=fake_content)):
            assert papylonation_constants.is_wsl() is False
    ...
    def test_result_is_cached(self):
        ...
        papylonation_constants._wsl_detected = True
