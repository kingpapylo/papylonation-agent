...
def test_session_search_lazily_opens_db_when_entrypoint_did_not_pass_one(monkeypatch):
    ...
    papylonation_state = ModuleType("papylonation_state")
    papylonation_state.SessionDB = FakeSessionDB
    monkeypatch.setitem(sys.modules, "papylonation_state", papylonation_state)
