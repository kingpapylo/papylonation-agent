...
class TestInterruptAutoPause:
    def test_interrupted_turn_pauses_goal_and_skips_continuation(self, papylonation_home):
        ...
        with patch("papylonation_cli.goals.judge_goal") as judge_mock:
    ...
    def test_interrupted_turn_is_resumable(self, papylonation_home):
        ...
        with patch("papylonation_cli.goals.judge_goal"):
            cli._maybe_continue_goal_after_turn()
...
class TestEmptyResponseSkip:
    def test_empty_response_does_not_invoke_judge(self, papylonation_home):
    ...
    def test_no_assistant_message_skipped(self, papylonation_home):
...
class TestHealthyTurnStillRuns:
    def test_clean_response_enqueues_continuation_when_judge_says_continue(
        ...
        with patch(
            "papylonation_cli.goals.judge_goal",
    ...
    def test_clean_response_marks_done_when_judge_says_done(self, papylonation_home):
...
class TestInterruptFlagLifecycle:
    def test_chat_resets_flag_at_entry(self, papylonation_home):
