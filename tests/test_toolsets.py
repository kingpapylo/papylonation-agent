...
class TestToolsetConsistency:
    ...
    def test_papylonation_platforms_share_core_tools(self):
...
class TestDefaultPlatformWebSearchCoverage:
    def test_papylonation_whatsapp_toolset_includes_web_search(self):
        assert "web_search" in resolve_toolset("hermes-whatsapp")

    def test_papylonation_api_server_toolset_includes_web_search(self):
