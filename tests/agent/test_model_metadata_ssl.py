...
class TestResolveRequestsVerify:
    ...
    def test_papylonation_ca_bundle_returns_path(self, clean_env, bundle_file):
    ...
    def test_priority_papylonation_over_requests(self, clean_env, tmp_path, bundle_file):
