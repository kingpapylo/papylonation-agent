...
def fake_homes(tmp_path, monkeypatch):
    ...
    Uses the real env-var resolution chain (get_papylonation_home /
    get_default_papylonation_root) instead of monkeypatching private helpers —
    ...
    HERMES_HOME=<root>/profiles/<name> makes get_default_papylonation_root()
