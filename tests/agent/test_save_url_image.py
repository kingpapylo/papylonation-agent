...
def http_server(tmp_path, monkeypatch):
    ...
    for mod in list(sys.modules):
        if mod.startswith("papylonation_constants") or mod.startswith("agent.image_gen_provider"):
...
class TestSaveUrlImage:
    def test_writes_real_bytes_to_papylonation_home_cache(self, http_server):
        base, _ = http_server
