...
def test_papylonation_meta_tolerates_non_dict():
    assert learning_graph._papylonation_meta({"metadata": "junk"}) == {}
    assert learning_graph._papylonation_meta({"metadata": {"hermes": "junk"}}) == {}
    assert learning_graph._papylonation_meta({"metadata": {"hermes": {"category": "x"}}}) == {"category": "x"}
