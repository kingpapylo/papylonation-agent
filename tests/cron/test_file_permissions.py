...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("papylonation_cli.config.get_config_path", return_value=config_path), \
             patch("papylonation_cli.config.ensure_papylonation_home"):
    ...
    def test_ensure_papylonation_home_sets_0700(self):
