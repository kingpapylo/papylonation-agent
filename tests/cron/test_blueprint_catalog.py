...
the shared /blueprint command handler (papylonation_cli/blueprint_cmd.py), and
...
class TestCommandHandler:
    ...
    def test_name_match_is_forgiving(self, isolated_home):
        from papylonation_cli.blueprint_cmd import handle_blueprint_command, match_blueprint
