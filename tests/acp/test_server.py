...
class TestSessionOps:
    ...
    async def test_new_session_returns_model_state(self):
        ...
        with patch(
            "papylonation_cli.models.curated_models_for_provider",
...
class TestSessionConfiguration:
    ...
    async def test_set_session_model_accepts_provider_prefixed_choice(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            "papylonation_cli.models.parse_model_input",
...
class TestPrompt:
    ...
    @pytest.mark.asyncio
    async def test_prompt_propagates_papylonation_session_id_env(self, agent, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_prompt_restores_prior_papylonation_session_id(self, agent, monkeypatch):
