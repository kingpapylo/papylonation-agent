...
@pytest.fixture
def papylonation_home(monkeypatch, tmp_path):
...
class TestPatchCRLFPreservation:
    def test_patch_on_crlf_file_stays_pure_crlf(self, papylonation_home, tmp_path):
    ...
    def test_patch_on_lf_file_stays_lf(self, papylonation_home, tmp_path):
    ...
    def test_patch_multiline_replacement_on_crlf(self, papylonation_home, tmp_path):
...
class TestWriteFileCRLFPreservation:
    def test_overwrite_crlf_file_with_lf_content_preserves_crlf(
        self, papylonation_home, tmp_path
    ):
    ...
    def test_new_file_written_as_is(self, papylonation_home, tmp_path):
    ...
    def test_overwrite_lf_file_stays_lf(self, papylonation_home, tmp_path):
