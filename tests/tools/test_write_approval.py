...
and the shared slash-command handlers (papylonation_cli/write_approval_commands.py).
...
@pytest.fixture
def papylonation_home(monkeypatch):
    d = tempfile.mkdtemp(prefix="papylonation_wa_test_")
...
def test_default_gate_is_off(papylonation_home):
...
def test_invalid_subsystem_is_off(papylonation_home):
    from tools import write_approval as wa
...
def test_memory_gate_off_allows_write(papylonation_home):
...
def test_memory_gate_on_no_interactive_stages(papylonation_home):
...
def test_memory_gate_on_then_apply(papylonation_home):
...
def test_cli_memory_approve_without_live_agent_uses_fresh_store(papylonation_home, capsys):
...
def test_load_on_disk_store_honors_configured_char_limits(papylonation_home, monkeypatch):
    ...
    monkeypatch.setattr("papylonation_cli.config.load_config", _boom)
...
def test_skill_gate_off_allows_create(papylonation_home):
...
def test_skill_gate_on_always_stages(papylonation_home):
...
def test_skill_gate_on_then_apply_writes_file(papylonation_home):
...
def test_skill_create_diff_is_full_content(papylonation_home):
    from tools.skill_manager_tool import skill_manage
    from tools import write_approval as wa
    _set_approval("skills", True)
...
def test_pending_store_roundtrip(papylonation_home):
    from tools import write_approval as wa
...
def test_handle_pending_list_empty(papylonation_home):
...
def test_handle_approve_all(papylonation_home):
    from papylonation_cli.write_approval_commands import handle_pending_subcommand
...
def test_handle_reject(papylonation_home):
    from papylonation_cli.write_approval_commands import handle_pending_subcommand
    from tools import write_approval as wa
...
def test_handle_approval_on(papylonation_home):
    from papylonation_cli.write_approval_commands import handle_pending_subcommand
    from tools import write_approval as wa
    captured = {}
...
def test_handle_approval_off(papylonation_home):
    from papylonation_cli.write_approval_commands import handle_pending_subcommand
    from tools import write_approval as wa
    captured = {}
    out = handle_pending_subcommand(
...
def test_handle_mode_alias_still_works(papylonation_home):
...
def test_handle_approval_invalid(papylonation_home):
    from papylonation_cli.write_approval_commands import handle_pending_subcommand
    from tools import write_approval as wa
...
def test_handle_unknown_subcommand_returns_none(papylonation_home):
    from papylonation_cli.write_approval_commands import handle_pending_subcommand
    from tools import write_approval as wa
...
def test_memory_inline_approve_writes(papylonation_home, approval_callback_cleanup):
    from tools.memory_tool import memory_tool, MemoryStore
    from tools.terminal_tool import set_approval_callback
    from tools import write_approval as wa
    _set_approval("memory", True)
...
def test_memory_inline_deny_blocks(papylonation_home, approval_callback_cleanup):
    from tools.memory_tool import memory_tool, MemoryStore
    from tools.terminal_tool import set_approval_callback
    from tools import write_approval as wa
    _set_approval("memory", True)
...
def test_memory_inline_callback_error_stages(papylonation_home, approval_callback_cleanup):
...
def test_gateway_context_stages_not_prompts(papylonation_home, monkeypatch):
...
def test_skills_never_prompt_inline_even_with_callback(papylonation_home, approval_callback_cleanup):
...
def test_memory_invalid_params_rejected_before_staging(papylonation_home):
