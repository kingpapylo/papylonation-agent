...
def test_check_website_access_uses_dynamic_papylonation_home(monkeypatch, tmp_path):
    ...
    # old HERMES_HOME set by the autouse _isolate_papylonation_home fixture.
