...
class TestDumpSubagentTimeoutDiagnostic:
    ...
    def test_writes_log_with_expected_sections(self, papylonation_home):
        ...
        assert p.parent == papylonation_home / "logs"
    ...
    def test_truncates_very_long_goal(self, papylonation_home):
        from tools.delegate_tool import _dump_subagent_timeout_diagnostic
        child = _StubChild()
        huge_goal = "x" * 5000
    ...
    def test_missing_worker_thread_is_handled(self, papylonation_home):
        from tools.delegate_tool import _dump_subagent_timeout_diagnostic
        child = _StubChild()
        path = _dump_subagent_timeout_diagnostic(
            child=child,
    ...
    def test_exited_worker_thread_is_handled(self, papylonation_home):
        from tools.delegate_tool import _dump_subagent_timeout_diagnostic
        child = _StubChild()
...
class TestRunSingleChildTimeoutDump:
    ...
    def test_zero_api_calls_writes_dump_and_surfaces_path(self, papylonation_home, monkeypatch):
        ...
        assert dump_path.parent == papylonation_home / "logs"
    ...
    def test_nonzero_api_calls_skips_dump_and_uses_old_message(self, papylonation_home, monkeypatch):
