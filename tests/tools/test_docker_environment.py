...
def test_init_env_args_uses_papylonation_dotenv_for_allowlisted_env(monkeypatch):
    ...
    monkeypatch.setattr(docker_env, "_load_papylonation_env_vars", lambda: {"DATABASE_URL": "value_from_dotenv"})
...
def test_init_env_args_prefers_shell_env_over_papylonation_dotenv(monkeypatch):
...
def test_init_env_args_uses_papylonation_dotenv_for_empty_shell_env(monkeypatch):
    ...
    monkeypatch.setattr(docker_env, "_load_papylonation_env_vars", lambda: {"MY_SECRET": "value_from_dotenv"})
...
def test_init_env_args_never_forwards_blank_secret(monkeypatch):
    ...
    monkeypatch.setenv("MY_SECRET", "")
    monkeypatch.setattr(docker_env, "_load_papylonation_env_vars", lambda: {})
...
def test_run_command_tags_papylonation_agent_label(monkeypatch):
