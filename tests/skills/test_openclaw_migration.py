...
def test_skill_installs_cleanly_under_skills_guard():
    ...
    # papylonation_config_mod  — print statements in the post-migration summary that
    ...
    KNOWN_FALSE_POSITIVES = {"agent_config_mod", "python_os_environ", "papylonation_config_mod"}
