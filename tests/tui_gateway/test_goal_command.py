...
def test_moa_bare_returns_usage(server, session, papylonation_home):
    _write_moa_config(papylonation_home, """
moa:
...
def test_moa_arg_is_always_one_shot(server, session, papylonation_home):
...
def test_moa_non_preset_returns_one_shot_send(server, session, papylonation_home):
    _write_moa_config(papylonation_home, """
moa:
  default_preset: default
  presets:
