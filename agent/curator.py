...
def _state_file() -> Path:
    return get_papylonation_home() / "skills" / ".curator_state"
...
def _reports_root() -> Path:
    ...
    ``ensure_papylonation_home()`` pre-creates this dir on every CLI launch and
    ...
    that bypasses both.
    """
    root = get_papylonation_home() / "logs" / "curator"
    try:
