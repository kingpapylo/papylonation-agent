...
def _ensure_reference_path_allowed(path: Path) -> None:
    ...
    papylonation_home = get_papylonation_home().resolve()

    blocked_exact = {home / rel for rel in _SENSITIVE_HOME_FILES}
    blocked_exact.add(papylonation_home / ".env")
    blocked_dirs = [home / rel for rel in _SENSITIVE_HOME_DIRS]
    blocked_dirs.extend(papylonation_home / rel for rel in _SENSITIVE_HERMES_DIRS)
