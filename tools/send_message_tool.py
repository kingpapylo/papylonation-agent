...
async def _send_to_platform(platform, pconfig, chat_id, message, thread_id=None, media_files=None, force_document=False):
    ...
    if platform == Platform.FEISHU and media_files:
        ...
        from papylonation_cli.plugins import discover_plugins as _dp_feishu
        _dp_feishu()
    ...
    if platform == Platform.WHATSAPP and media_files:
        ...
        from papylonation_cli.plugins import discover_plugins as _dp_wa
        _dp_wa()
...
#   - the ``hermes send`` CLI command (papylonation_cli/send_cmd.py)
