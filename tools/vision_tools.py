...
def _normalize_to_supported_image(
    ...
    out_dir = get_papylonation_dir("cache/vision", "temp_vision_images")
...
async def _vision_analyze_native(
    ...
    try:
        ...
        temp_dir = get_papylonation_dir("cache/vision", "temp_vision_images")
...
async def video_analyze_tool(
    ...
    try:
        ...
        if local_path.is_file():
            ...
            if blocked:
                raise PermissionError(blocked["message"])
            temp_dir = get_papylonation_dir("cache/video", "temp_video_files")
