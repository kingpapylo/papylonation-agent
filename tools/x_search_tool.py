...
from tools.xai_http import papylonation_xai_user_agent, resolve_xai_http_credentials
...
def check_x_search_requirements() -> bool:
    ...
    :func:`papylonation_cli.auth.resolve_xai_oauth_runtime_credentials` which
