...
bypasses the papylonation_cli wrapper — we want repeatable timing, not the CLI's
session-picker flow.
...
DEFAULT_LOG = Path(os.environ.get("HERMES_PERF_LOG", str(get_papylonation_home() / "perf.log")))
DEFAULT_STATE_DB = get_papylonation_home() / "state.db"
