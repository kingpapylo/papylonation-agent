...
class TelegramAdapter(BasePlatformAdapter):
    ...
    async def _run_post_connect_housekeeping(self) -> None:
        ...
        try:
            ...
            try:
                ...
                from papylonation_cli.commands import telegram_menu_commands, telegram_menu_max_commands
                if not self._bot:
                    return
    ...
    def _build_provider_keyboard(self, providers: list, page: int = 0) -> tuple:
        ...
        """
        try:
            from papylonation_cli.models import group_providers
        except Exception:
    ...
    async def _handle_model_picker_callback(
        ...
        if data.startswith("mp:"):
            ...
            group_id = data[4:]
            try:
                from papylonation_cli.models import PROVIDER_GROUPS
    ...
    def _message_mentions_bot(self, message: Message) -> bool:
        ...
        # raw substring matches like "foo@papylonation_bot.example" are not mentions
...
# papylonation_cli/{setup,gateway}.py, and the _send_telegram dispatch in
...
def interactive_setup() -> None:
    ...
    _PLATFORMS["telegram"] static dict dispatch in papylonation_cli/gateway.py.
    """
    from papylonation_cli import setup as _setup_mod
