...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_papylonation_home()`` helper (HERMES_HOME-aware and
...
RULES_FILE = get_papylonation_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_papylonation_home() / "feishu_comment_pairing.json"
