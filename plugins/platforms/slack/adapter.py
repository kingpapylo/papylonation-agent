...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        tokens_file = get_papylonation_home() / "slack_tokens.json"
        ...
        try:
            ...
            from papylonation_cli.commands import slack_native_slashes
            import re as _re
            ...
            async def handle_papylonation_command(ack, command):
            ...
            for _action_id in (
                "papylonation_approve_once",
                "papylonation_approve_session",
                "papylonation_approve_always",
                "papylonation_deny",
            ):
            ...
            for _action_id in (
                "papylonation_confirm_once",
                "papylonation_confirm_always",
                "papylonation_confirm_cancel",
            ):
                self._app.action(_action_id)(self._handle_slash_confirm_action)

            self._app.action("papylonation_feedback")(self._handle_feedback_action)
            ...
            "elements": [
                {
                    ...
                    "action_id": "papylonation_feedback",
                    "positive_button": {
            ...
            actions = [
                {
                    ...
                    "style": "primary",
                    "action_id": "papylonation_approve_once",
                    "value": session_key,
                },
            ]
            if not smart_denied:
                actions.append({
                    ...
                    "action_id": "papylonation_approve_session",
                    "value": session_key,
                })
                if allow_permanent:
                    actions.append({
                        ...
                        "action_id": "papylonation_approve_always",
                        "value": session_key,
                    })
            actions.append({
                "type": "button",
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "papylonation_confirm_once",
                            "value": value,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Approve"},
                            "action_id": "papylonation_confirm_always",
                            "value": value,
                        },
                        {
                            "type": "button",
                            ...
                            "style": "danger",
                            "action_id": "papylonation_confirm_cancel",
                            "value": value,
                        },
                    ],
                },
    ...
    async def _handle_slash_confirm_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "papylonation_confirm_once": "once",
            "papylonation_confirm_always": "always",
            "papylonation_confirm_cancel": "cancel",
        }
    ...
    async def _handle_approval_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "papylonation_approve_once": "once",
            "papylonation_approve_session": "session",
            "papylonation_approve_always": "always",
            "papylonation_deny": "deny",
        }
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        if slash_name in {"hermes", ""}:
            ...
            from papylonation_cli.commands import slack_subcommand_map
        ...
        # "Running /cmd…" ack shown by handle_papylonation_command).
...
# ``papylonation_cli/{setup,gateway}.py``, and the ``_send_slack`` dispatch in
...
def interactive_setup() -> None:
    ...
    offers to set a home channel. Replaces ``papylonation_cli/setup.py::_setup_slack``.
    """
    ...
    def _write_slack_manifest_and_instruct() -> None:
        ...
        try:
            from papylonation_cli.slack_cli import _build_full_manifest
            from papylonation_constants import get_papylonation_home
            import json as _json
            ...
            target = Path(get_papylonation_home()) / "slack-manifest.json"
...
def _is_connected(config) -> bool:
    ...
    Looks up via ``papylonation_cli.gateway.get_env_value`` at call time (not via the
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # Interactive setup wizard — replaces papylonation_cli/setup.py::_setup_slack
        # and the static _PLATFORMS["slack"] dict in papylonation_cli/gateway.py.
