...
try:
    ...
    import os as _os
    def get_papylonation_home() -> Path:  # type: ignore[misc]
...
def state_path() -> Path:
    return get_papylonation_home() / "plugins" / "hermes-achievements" / "state.json"


def snapshot_path() -> Path:
    return get_papylonation_home() / "plugins" / "hermes-achievements" / "scan_snapshot.json"


def checkpoint_path() -> Path:
    return get_papylonation_home() / "plugins" / "hermes-achievements" / "scan_checkpoint.json"
