...
def _default_registry_path() -> Path:
    return get_papylonation_home() / "state" / _REGISTRY_NAME
...
class HostSupervisor:
    ...
    def __init__(
        ...
        *,
        ...
        expected_papylonation_home: str | None = None,
        autostart: bool = True,
    ) -> None:
        ...
        self.expected_papylonation_home = expected_papylonation_home if expected_papylonation_home is not None else str(get_papylonation_home())
    ...
    def _validate_hello(self) -> None:
        ...
        got_home = str(hello.get("papylonation_home") or "")
        if got_home and got_home != self.expected_papylonation_home:
            raise RuntimeError(f"compute host HERMES_HOME mismatch: {got_home} != {self.expected_papylonation_home}")
